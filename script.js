...
//moving the title and betting container up
...
function playerHit() {
  ...
  if (playerNumber > 21) {
    ...
    gameLog.textContent = 'You got Blackjack!'; //fix the hidden card being shown when the player gets blackjack before presentation
